    ...
    <div className="bg-[#F7F8FC] font-sans text-slate-900 relative">
      ...
      <section className="relative flex flex-col items-center justify-start w-full z-10 overflow-hidden" style={{ height: "calc(100vh - 68px)", minHeight: "600px", paddingTop: "115px" }}>
        ...
        <div className="relative flex flex-col items-center w-full max-w-[1060px] mx-auto text-center px-4 z-10">
          {/* 1) Main Title */}
          <h1 className="whitespace-normal md:whitespace-nowrap" style={{
            fontSize: "48px",
            fontWeight: 900,
            color: "#111936",
        ...
        <div style={{ marginTop: "85px", display: "flex", flexDirection: "column", alignItems: "center", gap: "6px", zIndex: 10 }}>
          ...
          <svg width="12" height="12" fill="none" stroke="#AEB3C2" strokeWidth="2" viewBox="0 0 24 24" style={{ animation: "bounceSmall 2s infinite" }}>
        ...
        >
          ...
          <div className="flex w-full h-full" style={{ padding: '46px 42px' }}>
            ...
            <div style={{ width: '48%' }} className="flex flex-col pr-4">
              ...
              <div className="text-[11px] text-[#AEB3C2] font-semibold tracking-wide uppercase" style={{ marginTop: '22px', marginBottom: '32px' }}>
                Risk Assessment <span className="text-[#303545] font-bold ml-2">APR 2025 - APR 2026</span>
              </div>

              {/* Block 1: Network Security */}
              <div style={{ marginBottom: '36px' }}>
                <div className="flex items-center gap-2 mb-2 text-[#111936] font-bold text-[15px]">
                  <svg className="w-[10px] h-[10px] text-[#777B8A]" fill="currentColor" viewBox="0 0 20 20"><path d="M5 4l10 6-10 6V4z"/></svg>
                  Network Security
                </div>
                <div className="flex items-baseline gap-3 mb-4">
                  <span className="text-[42px] font-black text-[#111936] leading-none tracking-tight">95</span>
                ...
                <div className="flex justify-between text-[10px] text-[#AEB3C2] font-semibold leading-tight text-center px-1">
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 mb-2 text-[#111936] font-bold text-[16px]">
                  <svg className="w-[10px] h-[10px] text-[#777B8A]" fill="currentColor" viewBox="0 0 20 20"><path d="M5 4l10 6-10 6V4z"/></svg>
                  Access Compliance
                </div>
                <div className="flex items-baseline gap-3 mb-4">
                  <span className="text-[42px] font-black text-[#111936] leading-none tracking-tight">100</span>
            ...
            <div style={{ width: '52%' }} className="relative flex justify-center items-start pt-2">
              ...
              <div className="relative flex justify-center w-[360px]">
                <svg viewBox="0 0 360 220" className="w-full overflow-visible" style={{ animation: 'gaugeDraw 1.2s ease-out forwards' }}>
                  ...
                  {/* Curved Text */}
                  <text className="fill-[#111936] font-bold text-[26px]" style={{ fontFamily: 'Georgia, serif', letterSpacing: '0.02em' }}>
                  ...
                  <circle cx="180" cy="180" r="110" fill="none" stroke="#111936" strokeWidth="42" strokeDasharray="65 1000" strokeDashoffset="-552.92" />
                  ...
                  <polygon points="280,170 292,175 280,180" fill="#111936" transform="rotate(18 286 175)" />

                  {/* Center Text */}
                  <text x="180" y="165" textAnchor="middle" className="text-[76px] font-black fill-[#111936] tracking-tighter">95</text>
                  <text x="180" y="195" textAnchor="middle" className="text-[14px] font-bold fill-[#777B8A]">Security Score</text>
                ...
                <div 
                  className="absolute right-[-40px] bottom-[-70px] bg-white pt-4 pb-5 px-5 rounded-[12px] shadow-[0_15px_35px_rgba(0,0,0,0.12)] w-[210px] z-20 flex flex-col items-center text-center border border-slate-50"
                  style={{ animation: 'floatCard 6s ease-in-out infinite' }}
                >
                  <div className="w-[32px] h-[32px] rounded-full bg-[#F6C644] text-white flex items-center justify-center mb-3 shadow-sm mt-[-28px] border-[3px] border-white relative z-10">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" d="M5 13l4 4L19 7"/></svg>
                  </div>
                  <div className="absolute top-0 left-0 w-full h-8 bg-[#33363D] rounded-t-[12px]"></div>
                  <p className="text-[11px] font-bold text-[#111936] leading-[1.6] mt-1 relative z-10">
