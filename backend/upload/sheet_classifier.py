...
SHEET_TYPES: dict[str, dict] = {
    ...
    # ── high-risk mapping sheet (MUST come before risk_register) ──────────
    "high_risk": {
        "name_keywords": ["high-risk", "high risk", "top risks", "critical risks",
                          "key risks", "priority risks", "high risk mapping",
                          "risk mapping", "high-risk mapping"],
        "column_aliases": {
            "risk_id":          ["risk_id", "risk id", "id", "ref", "reference", "no",
                                 "number", "risk number", "risk ref"],
            "risk_statement":   ["risk_statement", "risk statement", "risk", "statement",
                                 "description", "risk_description", "risk description",
                                 "title", "risk name", "risk_name", "name"],
            "mapped_controls":  ["mapped_controls", "mapped controls", "control",
                                 "controls", "annex", "annex controls",
                                 "iso controls", "iso_controls", "control(s)",
            ...
            "rationale":        ["rationale", "reason", "justification",
                                 "explanation", "notes", "comments", "remarks",
                                 "why", "basis"],
            "likelihood":       ["likelihood", "probability", "chance",
                                 "frequency", "occurrence"],
            "impact":           ["impact", "consequence", "severity",
                                 "damage", "effect"],
            "risk_level":       ["risk_level", "risk level", "level", "rating",
                                 "risk_rating", "priority", "criticality"],
        },
    },
    "risk_register": {
        "name_keywords": ["risk register", "risk heatmap", "risk assessment",
                          "risk matrix", "heatmap", "heat map", "threat",
                          "vulnerability"],
        "column_aliases": {
